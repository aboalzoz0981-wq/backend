...
Route::prefix('admin')->controller(AdminController::class)->middleware(['auth:sanctum', 'Admin'])->group(function () {
    Route::put('/acceptUser/{id}', 'Accept');
    Route::delete('/rejectUser/{id}', 'Reject');
    /////////////////////////////////////////////
    Route::get('/showCustomer', 'showCustomers');
    Route::get('/showCompany', 'showCompanies');
    Route::get('/showAdmin', 'showAdmins');
    /////////////////////////////////////////////
    Route::get('/showCustomerRequests', 'acceptingCustomerRequests');
    Route::get('/showCompanyRequests', 'acceptingCompanyRequests');
    Route::get('/showAdminRequests', 'acceptingAdminRequests');
});
Route::prefix('order')->controller(ProductController::class)->middleware('auth:sanctum')->group(function () {
    Route::post('/addOrder/{product_id}', 'buying');
});
...
Route::prefix('product')->controller(ProductController::class)->middleware('auth:sanctum')->group(function () {
    ...
    Route::post('/add_product/electronicPart', [ProductController::class, 'AddElectronicPart']);
